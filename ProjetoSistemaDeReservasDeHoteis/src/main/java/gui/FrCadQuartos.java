...
public class FrCadQuartos extends javax.swing.JFrame {
private String tipoAntigo;
   private boolean editando;
   private GerenciadorDeQuartos gerente;
    
    public FrCadQuartos() throws FileNotFoundException, JsonProcessingException {
        initComponents();
        this.editando = false;
        this.tipoAntigo = " ";
        ...
        gerente.carregarDoArquivo("ListaQuartos.json");
    ...
    private void initComponents() {
        ...
        edtNumDoQuarto = new javax.swing.JTextField();
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(edtPreco, javax.swing.GroupLayout.DEFAULT_SIZE, 422, Short.MAX_VALUE)
                    .addComponent(edtTipo)
                    .addComponent(edtNumDoQuarto))
                .addGap(6, 6, 6))
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(edtNumDoQuarto, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        this.tipoAntigo = JOptionPane.showInputDialog("informe o tipo do quarto.");
      Quartos quartoEditando = this.gerente.buscar(tipoAntigo);
      
      if(quartoEditando != null){
          this.editando = true;
          this.LimparCampos();
          this.HabilitarCampos(true);
          this.objetoParaCampos(quartoEditando);
          
      }else{
          System.out.println("quarto inexistente.");
          JOptionPane.showMessageDialog(this, "quarto inexistente");
    }                                         
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        this.tipoAntigo = JOptionPane.showInputDialog("informe o tipo do quarto.");
         ...
         Quartos quarto = this.gerente.buscar(tipoAntigo);
         if(quarto == null){
               JOptionPane.showMessageDialog(this, "Quarto inexistente");
         }else{
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        Quartos novoQuarto = this.camposParaObjeto();
    if(this.editando == true)
         this.gerente.atualizar(this.tipoAntigo, novoQuarto);
     else     
     this.gerente.adicionar(novoQuarto);
     this.LimparCampos();
     this.HabilitarCampos(false);
     this.editando = false;
     ...
     edtListagem.setText(Listagem);
       ...
       try {
           gerente.salvarNoArquivo("ListaQuartos.json");
       } catch (IOException ex) {
           Logger.getLogger(FrCadQuartos.class.getName()).log(Level.SEVERE, null, ex);
       }
    }//GEN-LAST:event_btnSalvarActionPerformed

     public void objetoParaCampos(Quartos quarto){
         edtTipo.setText(quarto.getTipo());
         edtPreco.setText(quarto.getPreco() + " ");
         edtNumDoQuarto.setText(quarto.getNumDoQuarto() + " ");
     }
     
      public Quartos camposParaObjeto(){
         Quartos q = new Quartos();
         q.setTipo(edtTipo.getText().trim());
         ...
         String numeroStr = edtNumDoQuarto.getText().trim();
         if(!precoStr.isEmpty()){
         int numDoQuarto = Integer.parseInt(precoStr);
         q.setNumDoQuarto(numDoQuarto);
         }
    ...
    public void HabilitarCampos(boolean flag){
         ...
         edtNumDoQuarto.setEnabled(flag);
     }
     
     public void LimparCampos(){
         edtTipo.setText(" ");
         edtNumDoQuarto.setText(" ");
         edtPreco.setText(" ");
     }
    ...
    private javax.swing.JTextField edtNumDoQuarto;
